...
namespace StudentDatabase.Controllers
{
    public class TblStudentsController : Controller
    {
        ...
        public TblStudentsController(StudentDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentId,StudentName,FatherName,MotherName,DateOfBirth,Gender,Email,PhoneNumber,EmergencyPhoneNumber,AddressLine1,AddressLine2,State,City,District,ZipCode,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,IsDeleted,DeleteDate")] TblStudent tblStudent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,StudentName,FatherName,MotherName,DateOfBirth,Gender,Email,PhoneNumber,EmergencyPhoneNumber,AddressLine1,AddressLine2,State,City,District,ZipCode,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,IsDeleted,DeleteDate")] TblStudent tblStudent)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StudentDatabaseContext.TblStudents'  is null.");
            }
            var tblStudent = await _context.TblStudents.FindAsync(id);
            if (tblStudent != null)
            {
